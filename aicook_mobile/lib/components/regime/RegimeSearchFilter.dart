...
class RegimeSearchFilter extends StatefulWidget {
  RegimeSearchFilter({Key key}) : super(key: key);

  @override
  _RegimeSearchFilterState createState() => _RegimeSearchFilterState();
}

class _RegimeSearchFilterState extends State<RegimeSearchFilter> {
