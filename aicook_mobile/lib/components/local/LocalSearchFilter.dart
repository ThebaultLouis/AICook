...
class LocalSearchFilter extends StatefulWidget {
  LocalSearchFilter({Key key}) : super(key: key);

  @override
  _LocalSearchFilterState createState() => _LocalSearchFilterState();
}

class _LocalSearchFilterState extends State<LocalSearchFilter> {
