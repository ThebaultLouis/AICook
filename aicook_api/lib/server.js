...
// Aliment Category
const aliment_categories = require("./routes/aliment_category");
app.use("/api/aliment_categories", aliment_categories);
// Aliment
const aliments = require("./routes/aliment");
app.use("/api/aliments", aliments);
